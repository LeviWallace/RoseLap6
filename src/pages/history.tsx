...
export default function HistoryPage() {
	return (
		<div className="bg-background">
			<div className="flex flex-col center h-screen bg-cover bg-center" style={{ backgroundImage: `url(${bg})` }}>
				<Navbar />
				<div className="flex flex-col justify-center h-3/4 items-center text-center">
					<div>
						<h2 className="text-5xl font-bold text-primary font-italianno italic">the</h2>
						<h1 className="text-9xl font-bold text-primary font-italianno italic">HISTORY</h1>
						<h2 className="text-5xl font-bold text-primary font-italianno italic">of</h2>
					</div>
				</div>
			</div>
