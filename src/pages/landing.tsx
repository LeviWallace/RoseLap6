    ...
    return (
        <>
            ...
            <div className="flex flex-row h-screen w-full absolute top-0">
                <div className="flex w-1/3 h-screen hover:w-1/2 transition-all duration-500 bg-background items-center justify-center relative overflow-hidden cursor-pointer" onClick={() => navigate('/landing/tracks')}>
                ...
                <div className="flex w-1/3 h-screen hover:w-1/2 transition-all duration-500  bg-background items-center justify-center relative overflow-hidden cursor-pointer" onClick={() => navigate('/landing/sweeps')}>
                ...
                <div className="flex w-1/3 h-screen hover:w-1/2 transition-all duration-50 items-center justify-center relative overflow-hidden">
                    ...
                    <div className="flex flex-col w-full h-full">
                        <div className="flex h-1/2 hover:h-full w-full transition-all duration-200 relative cursor-pointer" onClick={() => navigate('/landing/vehicles')}>
                            <div className="h-full w-full bg-background opacity-80 hover:opacity-50 border-b-1 z-10 border-black absolute transition-opacity duration-500"></div>
                        ...
                        <div className="flex h-1/2 hover:h-full w-full transition-all duration-200 relative cursor-pointer" onClick={() => navigate('/landing/components')}>
                            <div className="h-full w-full bg-background opacity-80 hover:opacity-50 border-b-1 z-10 border-black absolute transition-opacity duration-500"></div>
                            <div className="flex h-full w-full items-center justify-center absolute">
                                <div className="pointer-events-none relative z-10">
