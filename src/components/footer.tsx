      ...
      <div className="min-h-[175px] w-full bg-background grid grid-cols-12 absolute">
        <div className="col-span-4 my-5 mx-6">
          <div className="flex flex-row">
            <h1 className="text-foreground text-4xl italic tracking-tight inline font-semibold">
              Rose
            </h1>
            <h1 className="text-primary text-4xl italic tracking-tight inline font-semibold">
              Lap
            </h1>
            <h1 className="text-foreground text-4xl italic tracking-tight inline font-semibold">
              6
          ...
          <h3 className="italic text-foreground font-thin">
            Rose-Hulman Institute of Technology's Formula SAE Team
          </h3>
        ...
        <div className="col-start-9 grid-col col-span-1 my-5 mx-10">
          ...
          <ul>
            {siteConfig.help.map((item) => (
              <li
                key={item.label}
                className="text-xs text-foreground my-2 font-thin capitalize"
              >
